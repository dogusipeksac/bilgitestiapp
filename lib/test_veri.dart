...
class TestVeri{
  ...
  int _soruDegis = 0;
    ...
    Soru(soruMetni:"Türkiyenin başkentş adanadır",soruYaniti:false ),
    Soru(soruMetni: "Adana ülkedir",soruYaniti:false ),
    Soru(soruMetni:"Adanalılar adamdır",soruYaniti:true  ),
